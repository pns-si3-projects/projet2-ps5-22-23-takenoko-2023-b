...
public class ParcelleList extends ListDuJeu<Parcelle> {
    ...
    public void init() {
        for (int i = 0; i < 6; i++) {
            list.add(new Parcelle(Couleur.VERT, new Amenagement(AmenagementType.DEFAULT)));
        }
        for (int i = 0; i < 2; i++) {
        ...
        for (int i = 0; i < 4; i++) {
            list.add(new Parcelle(Couleur.ROSE, new Amenagement(AmenagementType.DEFAULT)));
        }
        ...
        for (int i = 0; i < 6; i++) {
            list.add(new Parcelle(Couleur.JAUNE, new Amenagement(AmenagementType.DEFAULT)));
        }
